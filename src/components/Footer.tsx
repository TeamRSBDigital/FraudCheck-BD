...
export const Footer: React.FC<FooterProps> = ({ onOpenLegal }) => {
  return (
    <footer className="w-full border-t border-slate-200 bg-white mt-16 text-slate-600">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
        {/* Top Row: Fully centered on mobile, flex-row on lg */}
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 pb-6 border-b border-slate-100 text-center lg:text-left">
          {/* Brand Info */}
          ...
          {/* Right Section: Pills & Links centered on mobile */}
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center lg:justify-end gap-3 sm:gap-4 w-full lg:w-auto">
            {/* Pills Container */}
            <div className="flex flex-wrap items-center justify-center gap-2.5">
              ...
              {/* Quota Pill */}
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-blue-50/80 text-blue-900 text-xs font-semibold border border-blue-200/80 shadow-2xs">
            ...
            {/* Navigation Links */}
            <div className="flex items-center justify-center gap-3 sm:gap-4 text-xs font-semibold text-slate-600 pt-1 sm:pt-0">
              <button
                type="button"
        ...
        {/* Bottom Row: Fully centered on mobile, clean without unnecessary duplicate text */}
        <div className="pt-4 flex items-center justify-center text-center text-xs text-slate-500">
